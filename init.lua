...
require('lazy').setup({
      ...
      cmp.setup {
        ...
        window = {
          completion = cmp.config.window.bordered {
            ...
            col_offset = -3, -- Adjust the column offset to fit more information
            side_padding = 0,
          },
        ...
        formatting = {
          fields = { 'abbr', 'kind', 'menu' }, -- Display more information
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'go', 'html', 'lua', 'luadoc', 'markdown', 'rust', 'toml', 'vim', 'vimdoc' },
